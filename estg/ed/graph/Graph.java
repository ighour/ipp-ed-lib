...
/**
 * Implements graph with an adjacency matrix.
 * @author igu
 * @param <T>
 */
public class Graph<T> implements GraphADT<T> {
  ...
  */
   ...
   * Throws ElementNotFoundException if vertex is not found at graph.
   * Uses private changeEdge() method to handle edge update.
 ...
 */
  private void changeEdge(T vertex1, T vertex2, boolean newValue) throws ElementNotFoundException {
