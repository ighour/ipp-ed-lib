...
/**
 * Stack implemented with linked list. Using already implemented linked list. *
 * @author igu
 *
 * @param <T> generic
 */
public class LinkedStack<T> implements StackADT<T> {
    ...
    /**
     * Adds one element to the top of this stack. Inserts as sentinel next node.
     *
    ...
    /**
     * Removes and returns the top element from this stack. Removes from first
     * node after sentinel.
     *
