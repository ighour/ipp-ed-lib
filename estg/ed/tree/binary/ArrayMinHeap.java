...
/**
 * Minheap implementation with circular dynamic array. Using already implemented
...
public class ArrayMinHeap<T> extends ArrayHeap<T> implements HeapMinADT<T> {
    ...
    /**
     * Heapify up an element. Until element is smaller then parent. Uses
     * recursion.
     *
    ...
    /**
     * Removes element with the lowest value from this heap. Uses removeRoot()
     * method of ArrayHeap.
     *
    ...
    /**
     * Heapify down an element. Until parent is smaller or equal to children.
     * Uses recursion.
     *
