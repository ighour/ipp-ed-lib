...
/**
 * Binary tree implementation with circular dynamic array. Using already
 * implemented circular dynamic array.
 *
 * @param <T> generic
 */
public abstract class ArrayBinaryTree<T> implements BinaryTreeADT<T> {
    ...
    /**
     * Returns a reference to the root element. Uses internal circular dynamic
     * array get() method on first position.
     *
    ...
    /**
     * Returns true if this binary tree is empty and false otherwise. Uses
     * internal circular dynamic array isEmpty() method.
     *
    ...
    /**
     * Returns the number of elements in this binary tree. Uses internal
     * circular dynamic array size() method.
     *
     ...
     * @throws estg.ed.exceptions.ElementNotFoundException specified element is
     * not found
     */
    @Override
    ...
    /**
     * Search for targetElem in (sub)tree. Uses recursion. Uses internal
     * circular dynamic array to get elements.
     *
    ...
    /**
     * Returns the string representation of the binary tree. Using iterator in
     * level order.
     *
     ...
     * overloaded, recursive inorder method that starts with the root. Uses an
     * unordered array list to store elements order.
     *
    ...
    private void inorder(UnorderedListADT<T> list, int index) {
        ...
        if (leftIndex < this.array.size()) //Enter left child
        {
        ...
        if (rightChild < this.array.size()) //Enter right child
        {
     ...
     * overloaded, recursive preorder method that starts with the root. Uses an
     * unordered array list to store elements order.
     *
     * @return an iterator over the elements of this binary tree
     */
     ...
     * overloaded, recursive postorder method that starts with the root. Uses an
     * unordered array list to store elements order.
     *
     * @return an iterator over the elements of this binary tree
     */
    ...
    /**
     * Performs a levelorder traversal on the binary tree, using a queue. Uses
     * an unordered array list to store elements order. Uses a queue array to
     * store retrieve order of nodes before storing in list.
     *
     * @return an iterator over the elements of this binary tree
     */
    @Override
