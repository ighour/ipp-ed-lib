  ...
  */
  ...
  public T removeElement(T targetElement) throws ElementNotFoundException, EmptyCollectionException, NotComparableException {
    ...
    while(!targetComp.equals(currentNode.data)){
      ...
      if(targetComp.compareTo(currentNode.data) < 0)
    ...
    else if(currentNode.equals(parentNode.left))
      //Replace parentNode left child
      parentNode.left = this.replacement(currentNode);
    
    //Is right child of parentNode
    else
      //Replace parentNode right child
  ...
  public T removeMin() throws EmptyCollectionException {
    ...
    //Has left children
      ...
      if(currentNode.right == null)
        //parentNode left child became null
        parentNode.left = null;
      
      //Is an internal node (has right child)
      else
        //parentNode left child became currentNode right child
  ...
  public T removeMax() throws EmptyCollectionException {
    ...
    //Has right children
      ...
      //Is an internal node (has left child)
        ...
        //parentNode right child became currentNode left child
