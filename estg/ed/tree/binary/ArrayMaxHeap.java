...
/**
 * Maxheap implementation with circular dynamic array. Using already implemented
...
public class ArrayMaxHeap<T> extends ArrayHeap<T> implements HeapMaxADT<T> {
    ...
    /**
     * Heapify up an element. Until element is higher then parent. Uses
     * recursion.
     *
    ...
    /**
     * Removes element with the highest value from this heap. Uses removeRoot()
     * method of ArrayHeap.
     *
    ...
    /**
     * Heapify down an element. Until parent is higher or equal to children.
     * Uses recursion.
     *
