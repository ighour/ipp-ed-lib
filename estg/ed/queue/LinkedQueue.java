...
public class LinkedQueue<T> implements QueueADT<T> {
    ...
    /**
     * Adds one element to the rear of this queue. Inserts as front sentinel
     * next node if empty Inserts as rear sentinel next node
     *
     ...
     * first node after front sentinel.
     *
     ...
     * from first node after front sentinel.
     *
