...
/**
 * Node which implements comparable of itself. Priority uses double type.
 *
...
public class PriorityQueueNode<T> implements Comparable<PriorityQueueNode> {
    ...
    /**
     * Returns a string representation of this node. Returns result from data
     * toString(), priority and order.
     *
