...
/**
 * Contract for dynamic arrays. Which redimension itself when needed.
 *
 * @param <T> generic
 */
public interface DynamicArrayContract<T> {
    ...
    /**
     * Add an element to desired index. Increases array size if needed. Push
     * elements in array if needed.
     *
    ...
    /**
     * Remove an element from desired index. Pull elements in array if needed.
     *
    ...
    /**
     * Get length of array. Only counts valid indexes used by dynamic array.
     *
    ...
    /**
     * Check if array is empty. Only counts valid indexes used by dynamic array.
     *
