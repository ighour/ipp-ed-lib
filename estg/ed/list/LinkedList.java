...
public abstract class LinkedList<T> implements ListADT<T> {
    ...
    /**
     * Instantiate the list. Linking front and rear sentinels.
     */
    public LinkedList() {
    ...
    /**
     * Removes and returns the first element from this list. Removes first node
     * after front sentinel.
     *
    ...
    /**
     * Removes and returns the last element from this list. Removes first node
     * before rear sentinel.
     *
    ...
    /**
     * Removes and returns the specified element from this list. Removes desired
     * node.
     *
    ...
    /**
     * Returns a reference to the first element in this list. Returns first node
     * data after front sentinel.
     *
    ...
    /**
     * Returns a reference to the last element in this list. Returns first node
     * data before rear sentinel.
     *
    ...
    class InnerIterator implements Iterator<T> {
        ...
        /**
         * Instantiates iterator. Points to first node after front sentinel.
         * Store expectedModcount same as list. Set lastNext as null (there is
         * no lastNext). Set not ok to remove.
         */
